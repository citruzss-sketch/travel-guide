...
export const KNOWN_PLACES: Record<string, KnownPlace[]> = {
  ...
  "ho-chi-minh-city": [
    {
      id: "sgn-airport",
      names: ["Tan Son Nhat International Airport", "Tan Son Nhat Airport", "SGN Airport"],
      lat: 10.8188,
      lng: 106.6521,
    },
    {
      ...
      lat: 10.7724,
      lng: 106.6985,
      mapsUrl: "https://www.google.com/maps/place/Ben+Thanh+Market/@10.7724,106.6985,17z",
    },
    {
      id: "reunification-palace",
      names: ["Reunification Palace", "Independence Palace", "Dinh Thong Nhat"],
      lat: 10.7772,
      lng: 106.6956,
      mapsUrl: "https://www.google.com/maps/place/Reunification+Palace/@10.7772,106.6956,17z",
    },
    {
      id: "war-museum",
      ...
      lat: 10.7796,
      lng: 106.6922,
      mapsUrl: "https://www.google.com/maps/place/War+Remnants+Museum/@10.7796,106.6922,17z",
    },
    {
      id: "notre-dame",
      names: ["Notre Dame Cathedral Basilica of Saigon", "Notre Dame Cathedral"],
      lat: 10.7797,
      lng: 106.699,
    },
    {
      id: "jade-emperor",
      names: ["Jade Emperor Pagoda", "Chua Ngoc Hoang", "Phuoc Hai Tu"],
      lat: 10.7893,
      lng: 106.6944,
    },
    {
    ...
    {
      id: "bui-vien",
      names: ["Bui Vien Walking Street", "Bui Vien Street"],
      lat: 10.7679,
      lng: 106.6926,
    },
    {
    ...
    {
      id: "pho-2000",
      names: ["Pho 2000", "Pho 2000 restaurant"],
      lat: 10.7723,
      lng: 106.6972,
      address: "1-3 Phan Chu Trinh, Ben Thanh, District 1, Ho Chi Minh City",
    },
    {
      id: "saigon-station",
      names: ["Saigon Railway Station", "Ho Chi Minh City Railway Station"],
      lat: 10.7792,
      lng: 106.6796,
    },
    {
      id: "cu-chi",
      names: ["Cu Chi Tunnels", "Ben Dinh Tunnels"],
      lat: 11.1434,
      lng: 106.4613,
    },
  ],
