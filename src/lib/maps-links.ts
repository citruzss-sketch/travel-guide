...
export const KNOWN_PLACES: Record<string, KnownPlace[]> = {
  ...
  "hue": [
    {
      id: "imperial-citadel",
      names: ["Imperial Citadel", "Dai Noi", "Đại Nội", "Hue Citadel", "Imperial City Hue"],
      lat: 16.4698,
      lng: 107.5779,
    },
    {
      id: "thien-mu-pagoda",
      names: ["Thien Mu Pagoda", "Chùa Thiên Mụ", "Phuoc Duyen Tower"],
      lat: 16.4535,
      lng: 107.5507,
    },
    {
      id: "khai-dinh-tomb",
      names: ["Khai Dinh Tomb", "Lăng Khải Định", "Tomb of Khai Dinh"],
      lat: 16.4062,
      lng: 107.5773,
    },
    {
      id: "minh-mang-tomb",
      names: ["Minh Mang Tomb", "Lăng Minh Mạng", "Tomb of Minh Mang"],
      lat: 16.4237,
      lng: 107.5529,
    },
    {
      id: "tu-duc-tomb",
      names: ["Tu Duc Tomb", "Lăng Tự Đức", "Tomb of Tu Duc"],
      lat: 16.433,
      lng: 107.567,
    },
    {
      id: "dong-ba-market",
      names: ["Dong Ba Market", "Chợ Đông Ba", "Dong Ba"],
      lat: 16.4734,
      lng: 107.5934,
    },
    {
      id: "hui-airport",
      names: ["Phu Bai International Airport", "Phu Bai Airport", "HUI Airport", "HUI"],
      lat: 16.4015,
      lng: 107.703,
    },
    {
      id: "hue-station",
      names: ["Hue Railway Station", "Hue Train Station", "Ga Hue"],
      lat: 16.4633,
      lng: 107.5977,
    },
    {
      id: "truong-tien-bridge",
      names: ["Truong Tien Bridge", "Cầu Trường Tiền", "Truong Tien"],
      lat: 16.4681,
      lng: 107.5936,
    },
    {
      id: "thuan-an-beach",
      names: ["Thuan An Beach", "Bãi biển Thuận An"],
      lat: 16.5301,
      lng: 107.6926,
    },
    {
      id: "hanh-restaurant",
      names: ["Hanh Restaurant", "Restaurant Hanh Hue"],
      lat: 16.4635,
      lng: 107.5905,
      address: "11 Pho Duc Chinh, Hue",
    },
    {
      id: "ba-tuan",
      names: ["Bun Bo Hue Ba Tuan", "Ba Tuan", "Bún Bò Huế Bà Tuấn"],
      lat: 16.4715,
      lng: 107.5843,
      address: "14 Ly Thuong Kiet, Hue",
    },
  ],
};
