...
export const KNOWN_PLACES: Record<string, KnownPlace[]> = {
  ...
  "ho-chi-minh": [
    {
      id: "sgn-airport",
      names: ["Tan Son Nhat Airport", "SGN Airport", "Sân bay Tân Sơn Nhất"],
      lat: 10.8188,
      lng: 106.6519,
    ...
    {
      id: "ben-thanh",
      names: ["Ben Thanh Market", "Chợ Bến Thành"],
      lat: 10.7724,
      lng: 106.6983,
    ...
    {
      id: "war-museum",
      names: ["War Remnants Museum", "Bảo tàng Chứng tích Chiến tranh"],
      lat: 10.7797,
      lng: 106.6926,
    ...
    },
    {
      ...
      names: ["Reunification Palace", "Dinh Thống Nhất"],
      lat: 10.7769,
      lng: 106.6952,
    ...
    {
      id: "notre-dame",
      names: ["Notre-Dame Cathedral Saigon", "Nhà thờ Đức Bà Sài Gòn"],
      lat: 10.7797,
      lng: 106.699,
    ...
    {
      id: "jade-pagoda",
      names: ["Jade Emperor Pagoda", "Chùa Phước Hải", "Ngọc Hoàng Pagoda"],
      lat: 10.7895,
      lng: 106.6929,
    ...
    {
      id: "bitexco",
      names: ["Bitexco Financial Tower", "Saigon Skydeck"],
      lat: 10.7717,
      lng: 106.7033,
    ...
    {
      id: "bui-vien",
      names: ["Bui Vien Walking Street", "Phố Tây Bùi Viện"],
      lat: 10.7673,
      lng: 106.6946,
      address: "Bui Vien, Pham Ngu Lao, District 1, Ho Chi Minh City",
    },
    {
      id: "pham-ngu-lao",
      names: ["Pham Ngu Lao", "Pham Ngu Lao district"],
      lat: 10.7679,
      lng: 106.692,
      address: "Pham Ngu Lao, District 1, Ho Chi Minh City",
    },
    {
      id: "bach-dang-pier",
      names: ["Bach Dang Pier", "Bến Bạch Đằng", "Bach Dang Wharf"],
      lat: 10.7796,
      lng: 106.7048,
      address: "Bach Dang, Ben Nghe, District 1, Ho Chi Minh City",
    },
    {
      id: "ben-thanh-metro",
      names: ["Ben Thanh Metro Station", "Metro Bến Thành"],
      lat: 10.7722,
      lng: 106.698,
    ...
    {
      id: "pho-hoa-pasteur",
      names: ["Pho Hoa Pasteur", "Phở Hòa Pasteur"],
      lat: 10.7813,
      lng: 106.695,
    ...
    {
      id: "cho-lon",
      names: ["Cho Lon", "Chợ Lớn", "Binh Tay Market"],
      lat: 10.7524,
      lng: 106.6586,
